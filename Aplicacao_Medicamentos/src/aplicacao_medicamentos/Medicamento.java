...
abstract class Medicamento {
    ...
    public void proximaDoseMinistrada(){
        if( ultimaDose==null){
            System.out.println("A útlima dose não foi registrada! Por favor, faça o registro!");
        }
        // Vai mostrar o próximo horário em que a dose deve ser ministrada.
        proxima= ultimaDose.plusHours(frequencia);
        
        // Vai calcular a diferença de tempo entre a hora que a dose foi tomada e o horário que deve ser tomado.
        ...
        if(tempoRestante.isNegative()){
            System.out.println("Já passou do horário da dose! Por favor, insira o ovo horário da dose!");
        }else{
            //Irá mostrar o tempo que falta em horas e minutos, porém, sem contagem regressiva do tempo.
            System.out.println("Faltam: "+tempoRestante.toHours()+ "h e "+ (tempoRestante.toMinutes()% 60)+"min para a sua próxima dose!");
        }
    }
