...
public class TabelaHorarios extends javax.swing.JFrame {
    ...
    private void carregarDados() {
        List<Medicamento> lista = DadosApp.carregarTodosMedicamentosBanco();
        modelo.setRowCount(0);
         
        for (Medicamento m : lista) {
            LocalTime proximo = m.proximaDoseMinistrada();
            modelo.addRow(new Object[]{
                m.getNomeMedicamento(),
                proximo != null ? proximo.toString() : "Não registrado"
            });
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Tabela de horários de medicamentos:");
