 ...
 * @author menes
 */
public class TelaMedicamentoControlado extends javax.swing.JFrame {

    /**
     * Creates new form TelaMedicamentoControlado
     */
    public TelaMedicamentoControlado() {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try{
            ...
            DadosApp.listaTodosMedicamentos.add(med);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaMedicamentoControlado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaMedicamentoControlado().setVisible(true);
            }
        });
    }
